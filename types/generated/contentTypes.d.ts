...
export interface ApiBlogEntryBlogEntry extends Schema.CollectionType {
  ...
  attributes: {
    ...
    preview_picture: Attribute.Media<'images'> & Attribute.Required;
    preview_description: Attribute.String & Attribute.Required;
    date: Attribute.DateTime & Attribute.Required;
    related_entries: Attribute.Relation<
      'api::blog-entry.blog-entry',
      'oneToMany',
      'api::blog-entry.blog-entry'
    >;
...
export interface ApiBlogEntryHighlightedBlogEntryHighlighted
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::blog-entry-highlighted.blog-entry-highlighted': ApiBlogEntryHighlightedBlogEntryHighlighted;
